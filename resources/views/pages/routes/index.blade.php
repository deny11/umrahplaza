...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Kelola Daftar Rute Perjalanan</h2>
            ...
            <div class="x_content">
                ...
                <a href="{{ route('routes.add') }}">
                    <button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="right" title="Klik untuk tampilkan menu tambahkan rute baru"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Data</button></a>
                <br>
                <br>
                    ...
                    @foreach($routes as $item)
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle;">
                                <a href="{{ route('routes.update', ['id' => $item->id]) }}" class="btn btn-primary btn-xs"title="Sunting"><span class="glyphicon glyphicon-pencil"></span></a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ route('routes.delete', ['id' => $item->id]) }}">
