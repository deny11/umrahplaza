...
@section('title', 'Gambar Paket')
@section('content')

    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Kelola Daftar Gambar Paket</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                @include('layout.notif')

                <a href="{{URL::to('paket/addimage').'/'.$id}}">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    @foreach($images->images as $item)
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle;"><img src="{{URL::to('gambar/get').'/'.$item->id}}" style="overflow: hidden;" height="100px"></td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ URL::to('/paket/deleteimage').'/'.$id.'/'.$item->id }}">
