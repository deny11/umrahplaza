    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="right" title="Klik untuk tampilkan menu tambahkan Gambar baru"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Data</button></a>
                <br>
                <br>
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <img src="{{ route('images.get', ['id' => $airline->id]) }}" alt="" width="100px" height="70px">
                        </td>
                        <td class="text-center" style="vertical-align: middle;">
{{--                            <a href="{{ route('images.update', ['id' => $airline->id]) }}" class="btn btn-primary btn-xs"title="Sunting"><span class="glyphicon glyphicon-pencil"></span></a>--}}
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('images.delete', ['id' => $airline->id]) }}">
